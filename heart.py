...
COLORS = [
    ...
    (255, 20, 20),      # Ярко-красный
    (255, 50, 50),      # Светло-красный
    (230, 0, 0),        # Тёмно-красный
    (200, 0, 0),        # Насыщенный тёмно-красный
    (255, 30, 30),      # Огненно-красный
    (220, 20, 60),      # Малиновый
    (255, 10, 10),      # Супер-красный
    (240, 0, 0),        # Почти чистый красный
    (255, 40, 40),      # Яркий красный
    (0, 100, 0),        # Тёмно-зелёный (для контраста)
    (0, 80, 0),         # Очень тёмно-зелёный
]
...
def main():
    ...
    try:
        ...
        font_outline = pygame.font.Font(None, 20)
        font_fill = pygame.font.Font(None, 17)
        font_center = pygame.font.Font(None, 54)
    ...
    while running:
        ...
        if frame > center_start:
            ...
            # НАСЫЩЕННЫЙ КРАСНЫЙ ТЕКСТ
            center_surf = font_center.render(CENTER_TEXT, True, (255, 0, 0))  # Чистый красный!
            ...
            if center_alpha > 10:
                ...
                glow_center.set_alpha(center_alpha // 4)  # Увеличил яркость свечения
